...
public final class TestDisplayName {
	...
	public final static String PART_THREE_SAMPLE = "Part 3 - Sample data";
	public final static String PART_THREE_INPUT = "Part 3 - Input data";
	public final static String PART_THREE_DEBUG = "Part 3 - Debug";
